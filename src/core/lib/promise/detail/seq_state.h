...
template <template <typename> class Traits, typename P, typename F0,
          typename F1>
promise_detailtate_detail::SeqState<Traits, P, F0, F1> {
  using Promise0 = PromiseLike<P>;
  using PromiseResult0 = typename Promise0::Result;
  using PromiseResultTraits0 = Traits<PromiseResult0>;
  using NextFactory0 =
...
tm / namespace grpc_coreplate < template <typename>
                                class Traits,
    typename P, typename F0, typename F1,
    ;
;
;
;
typename F2;
> struct grpc_cgrpc_core::promise_detail::SeqStatemise_detail::SeqStatee::
        promise_detail::grpc_core::promise_detail::PromiseLikeaits,
    P, F0, F1,
    F2 > grpc_core::promise_detail::PromiseLikeromise0 = PromiseLike<P>;
using PromiseResult0 = typename Promise0::Result;
grpc_coreomise_detail::OncePromiseFactoryraits0 = Traits<PromiseResult0>;
